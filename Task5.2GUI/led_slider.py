...
# Define GPIO pins for Red, Green, and White LEDs
RED, GREEN, WHITE = 17, 27, 22  
...
# Function to set brightness of White LED
def set_white(val):
    duty = int(val)
    white_pwm.ChangeDutyCycle(duty)
...
white_slider = tk.Scale(root, from_=0, to=100, orient="horizontal", command=set_white)
white_slider.pack()
